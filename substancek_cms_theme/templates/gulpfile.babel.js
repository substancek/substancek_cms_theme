...
gulp.task('html', ['styles'], () => {
  ...
  return gulp.src('app/*.html')
    ...
    .pipe($.replace(/<script src="scripts\/([^"]*)"/g,
      '<script src="${request.static_url(\'substancek_cms_theme:templates/app/scripts/$1\')}"'))
    .pipe($.replace(/<link rel="stylesheet" href="styles\/([^"]*)"/g,
      '<link rel="stylesheet" href="${request.static_url(\'substancek_cms_theme:templates/app/styles/$1\')}"'))
    .pipe(gulp.dest('dist'));
});
